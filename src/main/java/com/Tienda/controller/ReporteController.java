...
public class ReporteController {
    ...
    @GetMapping("/VentasCate")
    public ResponseEntity<Resource> reporteVentas(@RequestParam String tipo)
            throws IOException {
        var reporte = "VentasCate";
        return reporteService.generaReporte(reporte, null, tipo);
    }

    @GetMapping("/CantExiste")
    public ResponseEntity<Resource> reporteCantExiste(@RequestParam String tipo)
            throws IOException {
        var reporte = "CantExiste";
        return reporteService.generaReporte(reporte, null, tipo);
    }
